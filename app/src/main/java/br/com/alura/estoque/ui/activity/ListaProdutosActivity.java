        ...
        new BaseAsyncTask<>(() -> {
           //execução síncrona
            ...
            if (produtosNovos != null){
                ...
                Toast.makeText(this, "Não foi possível achar os produtos", Toast.LENGTH_SHORT).show();
            }
        }).execute();

        //new BaseAsyncTask<>(dao::buscaTodos, resultado -> adapter.atualiza(resultado)).execute();
    }
